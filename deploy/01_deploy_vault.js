...
module.exports = async (hre) => {
    ...
    const farmlyInterestModel = await deploy("FarmlyInterestModel1", {
        from: deployer,
        log: true,
        args: [],
        waitConfirmations: 2,
    ...
    const farmlyVault = await deploy("FarmlyVault1", {
        from: deployer,
        log: true,
        args: [farmlyConfig.address, process.env.VAULT_TOKEN, "Farmly USDC Interest Bearing", "flyUSDC"],
        waitConfirmations: 2,
